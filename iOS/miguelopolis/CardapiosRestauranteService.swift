...
protocol CardapiosRestauranteRestService {
    
    func list(id: Int, callback: @escaping (RSServiceResponse<[Cardapios]>) -> Void)
    
}

struct CardapiosRestauranteService: CardapiosRestauranteRestService {
    ...
    enum Services: String, RSServiceEndpoint {
        case List = "/restaurantes/cardapios/%@"
    }
